          ...
          <MathJaxContext>
            <Container maxWidth="lg">
              ...
              >
                ...
                <section>
                  ...
                  >
                    <Typography variant="body1">
                      ...
                      system. The queue starts with M initial customers until
                ...
                <section>
                  ...
                  >
                    ...
                    <Typography variant="body1">
                      The algorithm iteratively increments time by the
                      inter-arrival time (1/λ) until it finds the first time
                      when the number of customers in the system reaches or
                      exceeds capacity:
                    </Typography>
                    <MathJax>{`\\[
              ...
              \\]`}</MathJax>
                    ...
                    <Box sx={{ ml: { xs: 3, sm: 5 } }}>
                      <Typography>
                        1. Empty queue (t {"<"} 1/λ): n(t) = 0
                      </Typography>
                      <Typography>
                        2. Filling phase (1/λ ≤ t {"<"} t_i):
                      </Typography>
                      <MathJax>{`\\[
                  n(t) = \\lfloor\\lambda t\\rfloor - \\lfloor\\mu t - \\frac{\\mu}{\\lambda}\\rfloor
                \\]`}</MathJax>
                      <Typography>
                        3. Steady state (t ≥ t_i): Alternates between k-1 and
                        k-2
                      </Typography>
                    </Box>
                    ...
                    <Typography variant="body1">
                      Determines if a service completion occurs at time t by
                      checking if the time since first service is a multiple of
                      service time:
                    </Typography>
                    <MathJax>{`\\[
              ...
              \\]`}</MathJax>
                    ...
                    <Box sx={{ ml: { xs: 3, sm: 5 } }}>
                      ...
                      <Box sx={{ ml: 2 }}>
                        <Typography>
                          - Queue is at capacity (k-1) with no service
                          completion, or
                        </Typography>
